"""
Django settings for noisy_cell_47988 project.
...
ROOT_URLCONF = 'noisy_cell_47988.urls'
...
WSGI_APPLICATION = 'noisy_cell_47988.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_cell_47988 API",
    "DESCRIPTION": "API documentation for noisy_cell_47988 App",
    "VERSION": "v1",
}
